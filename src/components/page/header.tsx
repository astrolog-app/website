        ...
        <div className="flex flex-col md:flex-row items-center">
            <div className={cn(className, "md:w-1/2 md:pr-12")}>
                ...
                <p className="text-zinc-400 mb-8 max-w-lg">
                    A practical tool for amateur and professional astrophotographers. Keep track of your sessions, gear,
                    and
            ...
            <div className="md:w-1/2 relative">
                <div className="relative rounded-lg overflow-hidden shadow-2xl shadow-red-900/20 border border-zinc-800">
                    <Image
                        height={200}
                        width={200}
                        src="/screenshot.png?height=600&width=800"
                        alt="AstroLog Dashboard"
